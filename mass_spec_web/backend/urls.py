...
from .views import tags_list, TagDetail, SpectrumDetail, spectrum_list, TagCreate, TagUpdate, TagDelete, \
    ...
    SupportDetail, SupportUpdate, SupportDelete, SignUpView, support_page, contacts, spectrum_certified_list, \
    rebuild_mini_plot

urlpatterns = [
    path('', main_page, name='main_page_url'),
    path('contacts/', cache_page(60)(contacts), name='contacts_page_url'),
    path('support_notifications/', cache_page(60)(support_page), name='support_page_url'),
    path('news/', news_page, name='news_page_url'),
    path('support/create/', cache_page(60)(SupportCreate.as_view()), name='support_create_url'),
    path('news/create/', cache_page(60)(NewsCreate.as_view()), name='news_create_url'),
    ...
    path('tag/create/', cache_page(60)(TagCreate.as_view()), name='tag_create_url'),
    ...
    path('spectrum_certified_list/', spectrum_certified_list, name='spectrum_certified_list'),
    ...
    path('rebuild_plots/', rebuild_mini_plot, name='rebuild_mini_plot')
]
